...
export function UnifiedLoginForm() {
  ...
  // 4. Autocompletar datos de prueba
      ...
      <div className="glass-panel rounded-3xl p-6 sm:p-8 shadow-2xl relative overflow-hidden">
        ...
        {activeTab === 'CUSTOMER' && (
          <div>
            ...
            {!isRegistering && (
              <>
                {/* Botón Google OAuth / Simulación 1-click */}
                <button
                  type="button"
                  onClick={() => {
                    autofillCredentials('cliente@gmail.com', 'cliente123');
                    setSuccessMsg('Credenciales cargadas. Haz clic en "Iniciar Sesión"');
                  }}
                  className="w-full py-3 px-4 rounded-xl bg-slate-900 border border-slate-700 hover:border-slate-600 text-white text-xs font-semibold flex items-center justify-center gap-3 transition-all hover:bg-slate-800/80 shadow-md group"
                >
                  ...
                  <span>Ingresar con Google (1-Click Demo)</span>
                </button>
